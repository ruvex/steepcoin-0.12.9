...
#define PUBLIC_PHRASE 			"The SteepCoin sucessfully launch at 10/01/2017.Your life,your rules.Be FREE.Be STEEP"	//+
...
#define GENESIS_MAIN_TIME 		1506875865		//+
#define GENESIS_TEST_TIME		1506875866		//+
#define GENESIS_RTEST_TIME		1506875867		//+
#define GENESIS_HASH_MERKL 		"0x23900140194a8df32c57b48c1a259e6c39596adf3499030877832cc79d55830a"		//+

#define GENESIS_MAIN_HASH 		"0x00000e902f9cea8a855ca2b02605a23eec18c8c76505251a08dddaa91cabdcd8"	//+
#define GENESIS_MAIN_NONCE 		48585																//+
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 60 * 60; // 60 min
        consensus.nPowTargetSpacing = 1 * 120; //  2 minutes
        ...
        vSeeds.push_back(CDNSSeedData("steepcoin.money"));
